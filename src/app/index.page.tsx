...
import avatar4 from "./img/avatar/310.avif" with { type: "image" };
import avatar5 from "./img/avatar/386.avif" with { type: "image" };
import { Colors } from "./utils/Colors";

export const GET: PageHandler = async ({ authenticate, head }) => {
		...
		<Page
			...
			{token ?
				<HomeButton
					...
					icon={
						<UserAvatar
							user={{ avatar: token.h ?? null, id: token.i }}
							size="2rem"
						/>
					}
