/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40135e0362b982a2e2869710b194c1e5)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SPOTIFY_PRIVATE_KEY: string;
		SPOTIFY_CLIENT_SECRET: string;
		SPOTIFY_WEBHOOK_URL: string;
		BRAWL_NOTIFICATIONS: Workflow<Parameters<import("./src/index").BrawlNotifications['run']>[0]['payload']>;
		CLASH_NOTIFICATIONS: Workflow<Parameters<import("./src/index").ClashNotifications['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEASON_ID" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "BULK_LIST_ID" | "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_TOKEN" | "OWNER_ID" | "NODE_ENV" | "TEST_GUILD" | "BRAWL_STARS_API_TOKEN" | "CLASH_ROYALE_API_TOKEN" | "PREDICTIONS_CHANNEL" | "PREDICTIONS_ROLE" | "BRAWL_STARS_CHANNEL" | "CLASH_ROYALE_CHANNEL" | "LIVE_CHANNEL" | "LIVE_MATCH_CHANNEL" | "WORDLE_CHANNEL" | "STATUS_CHANNEL" | "SPOTIFY_ID" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_REDIRECT_URI" | "SPOTIFY_PRIVATE_KEY" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_WEBHOOK_URL">> {}
}
