/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76bf88e47184227965889bb8f33c9ff8)
// Runtime types generated with workerd@1.20260424.1 2026-04-15 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		WEBSOCKET: Workflow<Parameters<import("./src/index").WebSocket['run']>[0]['payload']>;
		TOURNAMENT: Workflow<Parameters<import("./src/index").Tournament['run']>[0]['payload']>;
		CREATE_THREADS: Workflow<Parameters<import("./src/index").CreateThreads['run']>[0]['payload']>;
		LOCK_THREADS: Workflow<Parameters<import("./src/index").LockThreads['run']>[0]['payload']>;
	}
}
 ...
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/Request)
 */
interface Request<CfHostMetadata = unknown, Cf extends CfProperties = CfProperties<CfHostMetadata>> extends Body {
    /**
