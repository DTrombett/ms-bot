...
// Runtime types generated with workerd@1.20260708.1 2026-06-01 no_handle_cross_request_promise_resolution,nodejs_compat
interface __BaseEnv_Env {
	...
	NOTIFICATIONS: Workflow<
		Parameters<import("./src/index").Notifications["run"]>[0]["payload"]
	>;
	PREDICTIONS_REMINDERS: Workflow<
		Parameters<import("./src/index").PredictionsReminders["run"]>[0]["payload"]
	>;
	REMINDER: Workflow<
		Parameters<import("./src/index").Reminder["run"]>[0]["payload"]
	>;
	SHORTEN: Workflow<
		Parameters<import("./src/index").Shorten["run"]>[0]["payload"]
	>;
	TOURNAMENT: Workflow<
		Parameters<import("./src/index").Tournament["run"]>[0]["payload"]
	>;
	CHANNELS: Workflow<
		Parameters<import("./src/index").Channels["run"]>[0]["payload"]
	>;
	DELETE_CHANNELS: Workflow<
		Parameters<import("./src/index").DeleteChannels["run"]>[0]["payload"]
	>;
}
...
declare namespace CloudflareWorkersModule {
	...
	export abstract class WorkflowStep {
		...
		do<T extends Rpc.Serializable<T>, C extends WorkflowStepConfig>(
			name: string,
			config: C,
			callback: (
				ctx: WorkflowStepContext<
