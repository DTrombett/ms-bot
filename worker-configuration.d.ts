/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a27c4c0c589e79cf0de527cb5582ac72)
// Runtime types generated with workerd@1.20260730.1 2026-07-31 no_handle_cross_request_promise_resolution,nodejs_compat
interface __BaseEnv_Env {
	...
	BRAWL_STARS_CHANNEL: string;
	CLASH_ROYALE_CHANNEL: string;
	LIVE_CHANNEL: string;
	LIVE_MATCH_CHANNEL: string;
	WORDLE_CHANNEL: string;
	STATUS_CHANNEL: string;
	SECRET_KEY: string;
	NOTIFICATIONS: Workflow<Parameters<import("./src/index").Notifications['run']>[0]['payload']>;
	PREDICTIONS_REMINDERS: Workflow<Parameters<import("./src/index").PredictionsReminders['run']>[0]['payload']>;
	REMINDER: Workflow<Parameters<import("./src/index").Reminder['run']>[0]['payload']>;
	SHORTEN: Workflow<Parameters<import("./src/index").Shorten['run']>[0]['payload']>;
	TOURNAMENT: Workflow<Parameters<import("./src/index").Tournament['run']>[0]['payload']>;
	CHANNELS: Workflow<Parameters<import("./src/index").Channels['run']>[0]['payload']>;
	DELETE_CHANNELS: Workflow<Parameters<import("./src/index").DeleteChannels['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEASON_ID" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "BULK_LIST_ID" | "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_CLIENT_SECRET" | "DISCORD_TOKEN" | "OWNER_ID" | "NODE_ENV" | "TEST_GUILD" | "MAIN_GUILD" | "ALLOWED_ROLES" | "BRAWL_STARS_API_TOKEN" | "CLASH_ROYALE_API_TOKEN" | "PREDICTIONS_CHANNEL" | "PREDICTIONS_ROLE" | "BRAWL_STARS_CHANNEL" | "CLASH_ROYALE_CHANNEL" | "LIVE_CHANNEL" | "LIVE_MATCH_CHANNEL" | "WORDLE_CHANNEL" | "STATUS_CHANNEL" | "SECRET_KEY">> {}
}
...
interface Request<
	CfHostMetadata = unknown,
	Cf extends CfProperties = CfProperties<CfHostMetadata>,
> extends Body {
	/**
...
type AiSearchMultiSearchError = { instance_id: string; message: string };
...
type AiSearchMultiChatCompletionsResponse = Omit<
	...
	"chunks"
> & { chunks: AiSearchMultiSearchChunk[]; errors?: AiSearchMultiSearchError[] };
...
type AiSearchStatsResponse = {
	...
	engine?: {
		vectorize?: { vectorsCount: number; dimensions: number };
		r2?: {
...
type AiSearchUploadItemOptions = { metadata?: Record<string, unknown> };
...
type AiSearchItemChunksResponse = {
	...
	result_info: { count: number; total: number; limit: number; offset: number };
};
// ============ AI Search Job Types ============
...
type AiSearchCreateJobParams = { description?: string };
type AiSearchListJobsParams = { page?: number; per_page?: number };
...
type AiSearchJobLogsParams = { page?: number; per_page?: number };
...
type ChatCompletionContentPartRefusal = { type: "refusal"; refusal: string };
...
type ChatCompletionCustomToolTextFormat = { type: "text" };
...
type FunctionMessage = { role: "function"; content: string; name: string };
type ChatCompletionMessageParam =
	...
	| ToolMessage
	| FunctionMessage;
type ChatCompletionsResponseFormatText = { type: "text" };
type ChatCompletionsResponseFormatJSONObject = { type: "json_object" };
...
type PromptTokensDetails = { cached_tokens?: number; audio_tokens?: number };
...
interface Ai_Cf_Black_Forest_Labs_Flux_2_Dev_Input {
	multipart: { body?: object; contentType?: string };
}
...
type AiAsyncBatchResponse = { request_id: string };
...
interface BasicImageTransformations {
	...
	trim?:
		...
		| {
				...
				height?: number;
				border?:
					boolean | { color?: string; tolerance?: number; keep?: number };
		  };
	/**
...
declare namespace CloudflareWorkersModule {
	...
	export type WorkflowStepContext<Delay = WorkflowDelayDuration | number> = {
		...
		attempt: number;
		config: {
			retries?: { limit: number; backoff?: WorkflowBackoff } & (Delay extends (
	...
	export abstract class WorkflowStep {
		...
		do<T extends Rpc.Serializable<T>, const C extends WorkflowStepConfig>(
			...
			callback: (
				ctx: WorkflowStepContext<
					C["retries"] extends { delay: infer D } ? D
